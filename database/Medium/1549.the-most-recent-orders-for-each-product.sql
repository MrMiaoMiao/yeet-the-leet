...
-- case of a tie by the product_id in ascending order. If there still a tie,
-- order them by the order_id in ascending order.
-- 
...
-- day.
-- mouse's most recent order is in 2020-08-03, it was ordered only once this
-- day.
-- screen's most recent order is in 2020-08-29, it was ordered only once this
-- day.
