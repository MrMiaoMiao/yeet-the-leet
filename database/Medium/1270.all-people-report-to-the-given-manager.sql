...
-- Testcase Example:  '{"headers":{"Employees":["employee_id","employee_name","manager_id"]},"rows":{"Employees":[[1,"Boss",1],[3,"Alice",3],[2,"Bob",1],[4,"Daniel",2],[7,"Luis",4],[8,"John",3],[9,"Angela",8],[77,"Robert",1]]}}\r'
--
-- Table: Employees
-- 
-- 
...
-- head of the company.
-- The employee with employee_id 4 report his work indirectly to the head of
-- the company 4 --> 2 --> 1. 
-- The employee with employee_id 7 report his work indirectly to the head of
-- the company 7 --> 4 --> 2 --> 1.
