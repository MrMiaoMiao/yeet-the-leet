...
-- Testcase Example:  '{"headers": {"survey_log": ["id", "action", "question_id", "answer_id", "q_num", "timestamp"]},"rows": {"survey_log": [[5, "show", 285, null, 1, 123], [5, "answer", 285, 124124, 1, 124], [5, "show", 369, null, 2, 125], [5, "skip", 369, null, 2, 126]]}}'
--
...
-- answer_id is not null when action column is "answer", while is null for
-- "show" and "skip"; q_num is the numeral order of the question in current
-- session.
-- 
