...
-- Testcase Example:  '{"headers": {"Product": ["product_id", "product_name"], "Sales": ["product_id", "period_start", "period_end", "average_daily_sales"]}, "rows": {"Product": [[1, "LC Phone "], [2, "LC T-Shirt"], [3, "LC Keychain"]], "Sales": [[1, "2019-01-25", "2019-02-28", 100], [2, "2018-12-01", "2020-01-01", 10], [3, "2019-12-01", "2020-01-31", 1]]}}\r'
--
-- Table: Product
-- 
-- 
...
-- +------------+--------------+-------------+--------------+
-- LC Phone was sold for the period of 2019-01-25 to 2019-02-28, and there are
-- 35 days for this period. Total amount 35*100 = 3500. 
