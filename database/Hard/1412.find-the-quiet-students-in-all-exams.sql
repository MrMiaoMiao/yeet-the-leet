--
-- @lc app=leetcode id=1412 lang=mysql
--
...
-- Testcase Example:  '{"headers": {"Student": ["student_id", "student_name"], "Exam": ["exam_id", "student_id", "score"]}, "rows": {"Student": [[1, "Daniel"], [2, "Jade"], [3, "Stella"], [4, "Jonathan"], [5, "Will"]], "Exam": [[10, 1, 70], [10, 2, 80], [10, 3, 90], [20, 1, 80], [30, 1, 70], [30, 3, 80], [30, 4, 90], [40, 1, 60], [40, 2, 70], [40, 4, 80]]}}\r'
--
-- Table: Student
-- 
-- 
...
-- For exam 3 and 4: Studnet 1 and 4 hold the lowest and high score
-- respectively.
