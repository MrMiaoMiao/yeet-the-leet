--
-- @lc app=leetcode id=1336 lang=mysql
--
...
-- transaction_date.(i.e The Visits table contains (user_id, transaction_date)
-- in one row)
-- 
-- 
-- 
...
-- "2020-01-02"), (12, "2020-01-01") and (19, "2020-01-03") did no transactions
-- so visits_count = 4.
-- * For transactions_count = 1, The visits (2, "2020-01-03"), (7,
-- "2020-01-11"), (8, "2020-01-28"), (1, "2020-01-02") and (1, "2020-01-04")
-- did one transaction so visits_count = 5.
