...
-- equal 15, Hot if the average weather_state is greater than or equal 25 and
-- Warm otherwise.
-- 
...
-- Cold.
-- Average weather_state in Austraila in November is (-2 + 0 + 3) / 3 = 0.333
-- so weather type is Cold.
-- Average weather_state in Peru in November is (25) / 1 = 25 so weather type
-- is Hot.
-- Average weather_state in China in November is (16 + 18 + 21) / 3 = 18.333 so
-- weather type is Warm.
-- Average weather_state in Morocco in November is (25 + 27 + 31) / 3 = 27.667
