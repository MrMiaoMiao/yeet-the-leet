...
-- unique users with invoices > $20 for each different month.
-- 
...
-- invoices > $20.
-- In October 2020 we have two orders from 1 customer, and only one of the two
-- orders has invoice > $20.
...
-- $20.
-- In January 2021 we have two orders from 2 different customers, but only one
-- of them with invoice > $20.
-- 
--
