/*
 * @lc app=leetcode id=1500 lang=javascript
 *
 ...
 * of the file, the system should assign an id to the user which is the
 * smallest positive integer not taken by any other user. Return the assigned
 * id.
 ...
 * chunk with chunkID. Return a list of the IDs of all users that own this
