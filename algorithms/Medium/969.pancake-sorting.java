 ...
 * 
 * 
 * For example, if A = [3,2,1,4] and we performed a pancake flip choosing k =
 * 2, we reverse the sub-array [3,2,1], so A = [1,2,3,4] after the pancake flip
 * at k = 2.
 * 
 ...
 * 1 <= A.length <= 100
 * 1 <= A[i] <= A.length
 * All integers in A are unique (i.e. A is a permutation of the integers from 1
 * to A.length).
 * 
 * 
 */
