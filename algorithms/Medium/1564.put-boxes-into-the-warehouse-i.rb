#
# @lc app=leetcode id=1564 lang=ruby
#
...
#
# Given two arrays of positive integers boxes and warehouse representing the
# heights of some boxes of unit width, and the heights of n rooms in a
# warehouse, respectively. The warehouse's rooms are labeled from 0 to n - 1
# from left to right where warehouse[i] (0-indexed) is the height of the i^th
# room.
# 
...
# then the box will be stopped before that room, so are the boxes behind it.
# 
# 
