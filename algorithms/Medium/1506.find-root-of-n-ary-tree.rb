#
# @lc app=leetcode id=1506 lang=ruby
#
...
#
# Given all the nodes of an N-ary tree as an array  Node[] tree where each node
# has a unique value.
# 
...
# random order and you need to find the root of the tree out of these nodes.
# 
# 
# Example 1:
# 
...
# [Node(1),Node(3),Node(2),Node(4),Node(5),Node(6)], then the array is randomly
# shuffled, thus the actual input is
