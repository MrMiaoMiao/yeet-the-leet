#
# @lc app=leetcode id=1489 lang=ruby
#
...
# cause the MST weight to increase is called a critical edge. A pseudo-critical
# edge, on the other hand, is that which can appear in some MSTs but not all.
# 
