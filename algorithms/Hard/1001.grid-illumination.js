 ...
 * that the lamp at grid[xi][yi] will be turned on. When a lamp is turned on,
 * it illiminates its cell and any cell in the same row, column or diagonal
 * with this this cell.
 * 
 ...
 * blue square) and as it is illuminated, we return 1. Then we turn off any
 * lamp in the red square.
 * 
